...
const getConfig = async () => {
  ...
  return {
    ...
    chains: {
      6648936: {
        // the domain ID for Ethereum Mainnet
        providers: [process.env.RPC_MAINNET],
      },
      1886350457: {
        // the domain ID for Polygon
        providers: [process.env.RPC_POLYGON],
      },
      1634886255: {
        // the domain ID for Arbitrum
        providers: [process.env.RPC_ARBITRUM],
      },
      1869640809: {
        // the domain ID for Optimism
        providers: [process.env.RPC_OPTIMISM],
      },
      6778479: {
        // the domain ID for Gnosis
        providers: [process.env.RPC_GNOSIS],
      },
      6450786: {
        // the domain ID for Binance Smart Chain
        providers: [process.env.RPC_BINANCE],
      },
    },
  };
